...
class EncodingHelperTest {
    ...
    @Test
    void shouldCheckGitBashOnWindows() {
        boolean result = EncodingHelper.isGitBashOnWindows();
        
        assertThat(result).isIn(true, false);
    }

    @Test
    void shouldDetermineShouldUseAsciiCharacters() {
        boolean result = EncodingHelper.shouldUseAsciiCharacters();
        
        assertThat(result).isIn(true, false);
    }

    @Test
    void shouldGetDoubleHorizontalLine() {
        String line = EncodingHelper.getDoubleHorizontalLine();
        
        assertThat(line).isIn("=", "═");
    }

    @Test
    void shouldGetSingleHorizontalLine() {
        String line = EncodingHelper.getSingleHorizontalLine();
        
        assertThat(line).isIn("-", "─");
    }

    @Test
    void shouldGetBulletPoint() {
        String bullet = EncodingHelper.getBulletPoint();
        
        assertThat(bullet).isIn("*", "▪");
    }

    @Test
    void shouldGetBoxTopLeft() {
        String corner = EncodingHelper.getBoxTopLeft();
        
        assertThat(corner).isIn("+", "┌");
    }

    @Test
    void shouldGetBoxTopRight() {
        String corner = EncodingHelper.getBoxTopRight();
        
        assertThat(corner).isIn("+", "┐");
    }

    @Test
    void shouldGetBoxBottomLeft() {
        String corner = EncodingHelper.getBoxBottomLeft();
        
        assertThat(corner).isIn("+", "└");
    }

    @Test
    void shouldGetBoxBottomRight() {
        String corner = EncodingHelper.getBoxBottomRight();
        
        assertThat(corner).isIn("+", "┘");
    }

    @Test
    void shouldGetBoxVerticalLine() {
        String line = EncodingHelper.getBoxVerticalLine();
        
        assertThat(line).isIn("|", "│");
    }

    @Test
    void shouldGetBoxMiddleLeft() {
        String middle = EncodingHelper.getBoxMiddleLeft();
        
        assertThat(middle).isIn("+", "├");
    }

    @Test
    void shouldGetBoxMiddleRight() {
        String middle = EncodingHelper.getBoxMiddleRight();
    ...
    void shouldCreateSeparatorLine() {
        String line = EncodingHelper.createSeparatorLine("=", 10);
    ...
    @Test
    void shouldCreateSeparatorLineWithDifferentCharacter() {
        String line = EncodingHelper.createSeparatorLine("-", 5);
    ...
    @Test
    void shouldCreateEmptySeparatorLineForZeroLength() {
        String line = EncodingHelper.createSeparatorLine("*", 0);
